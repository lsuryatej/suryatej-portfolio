      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 pb-16 pt-24">
        <div className="grid gap-16 lg:grid-cols-[3fr_2fr] lg:items-start">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div
              className="mt-8 mb-6"
              style={{ height: "2px", background: "var(--accent)", width: "100%" }}
            />

            {/* Editorial tagline */}
            <p
              className="editorial text-[var(--text-muted)]"
            ...
            <div className="mt-10 flex items-center gap-8">
              <a
                href="#projects"
                className="mono-tag text-[var(--text-faint)] transition-colors duration-200 hover:text-[var(--accent)]"
              >
                View work ↓
              </a>
              <a
